...
bool isSaving = false; // Add this variable to track if the address is currently being saved
...
final userIdProvider = Provider.of<UserIdProvider>(context, listen: false);
  ...
  if (_formKey.currentState!.validate()) {
    try {
      ...
      final apiUrl = 'http://10.0.2.2:8000/api/address'; // Replace with your actual API URL
